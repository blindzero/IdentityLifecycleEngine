...
For the conceptual model (why capabilities exist, how discovery/merging works, and how validation behaves), see [About -> Provider capabilities](../about/provider-capabilities).
