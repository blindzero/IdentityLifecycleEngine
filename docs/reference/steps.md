...
| [IdLE.Step.Mailbox.EnsureOutOfOffice](steps/step-mailbox-out-of-office-ensure.md) | ``IdLE.Steps.Mailbox`` | Ensures that a mailbox Out of Office (OOF) configuration matches the desired state. |
| [IdLE.Step.Mailbox.EnsureType](steps/step-mailbox-type-ensure.md) | ``IdLE.Steps.Mailbox`` | Ensures that a mailbox is of the desired type (User, Shared, Room, Equipment). |
