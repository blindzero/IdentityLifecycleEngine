    ...
    },
    {
      ...
      items: [
        ...
        'use/quickstart',
        {
          ...
          collapsed: true,
          items: [
            'use/walkthrough/workflow-definition',
            'use/walkthrough/request-creation',
            'use/walkthrough/plan-creation',
            'use/walkthrough/invoke-results',
            'use/walkthrough/providers-authentication',
          ],
        },
        'use/workflows',
        'use/providers',
